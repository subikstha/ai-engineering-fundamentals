...
export const tools = {
  ...
  modifyDiagram: tool({
    description:
      "Modify an existing elements on the canvas by id. Set only the fields you want to change, leave everything else alone please.",
    inputSchema: z.object({
      ...
      execute: async ({ elementId, updates }) => {
        // Modify the element with the given id using the updates object
